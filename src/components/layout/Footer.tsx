      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <FooterLink href="/cursussen">Alle cursussen</FooterLink>
              <FooterLink href="/leertrajecten">Leertrajecten</FooterLink>
              <FooterLink href="/trainers">Onze trainers</FooterLink>
              <FooterLink href="/locaties">Locaties</FooterLink>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <FooterLink href="/over-ons">Over Vijfhart</FooterLink>
              <FooterLink href="/blog">Blog</FooterLink>
              <FooterLink href="/evenementen">Evenementen</FooterLink>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/voorwaarden" className="text-gray-500 hover:text-white text-sm">
